...
describe('Application', () => {
  it('should find data', async () => {
    ...
    const textField = appComponent
      .getByTestId(/search-stops/i)
      .querySelector('input');
    ...
    await waitForExpect(() => {
      expect(appComponent.getByText(/Tekniikantie/i)).toBeInTheDocument();
    });
  });
});
...
//     let appComponent: RenderResult | null = null;
//     await act(async () => {
//       appComponent = render(
//         <MockedProvider mocks={mocks} addTypename={false}>
...
//     await waitForExpect(() => {
//       expect(appComponent.getByText(/ERROR/i)).toBeInTheDocument();
//     });
//   });
// });
